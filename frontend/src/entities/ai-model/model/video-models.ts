...
export const videoProviders: VideoProvider[] = [
  {
    ...
    badge: "Топ",
    subModels: [
      { id: "kling-3.0", name: "Kling 3.0", credits: 75, isNew: true, isDefault: true, desc: "Топовое видео", time: "60 сек", estimatedMinutes: 1 },
      { id: "kling-3.0-motion", name: "Kling 3.0 Motion Control", credits: 75, isNew: true, desc: "Контроль движения", time: "60 сек", estimatedMinutes: 1 },
      { id: "kling-2.6", name: "Kling 2.6", credits: 75, desc: "Стабильная", time: "60 сек", estimatedMinutes: 1 },
      { id: "kling-2.5-turbo", name: "Kling 2.5 Turbo", credits: 30, desc: "Быстрая", time: "60 сек", estimatedMinutes: 1 },
      { id: "kling-o1", name: "Kling O1", credits: 75, desc: "Мультимодальная", time: "60 сек", estimatedMinutes: 1 },
      { id: "kling-01", name: "Kling 01", credits: 75, desc: "Стандартная", time: "60 сек", estimatedMinutes: 1 },
    ],
  ...
  },
  {
    ...
    badge: "60% OFF",
    subModels: [
      { id: "seedance-2.0", name: "Seedance 2.0", credits: 48, isNew: true, isDefault: true, badge: "60% OFF", desc: "Кинематографичный мир", time: "120 сек", estimatedMinutes: 2 },
      { id: "seedance-1.0", name: "Seedance 1.0", credits: 60, desc: "Стандартная", time: "120 сек", estimatedMinutes: 2 },
    ],
  ...
  },
  {
    ...
    badge: "Google",
    subModels: [
      { id: "veo-3", name: "Veo 3", credits: 120, isNew: true, isDefault: true, desc: "Топовая модель Google", time: "120 сек", estimatedMinutes: 2 },
    ],
  ...
  },
  {
    ...
    badge: "OpenAI",
    subModels: [
      { id: "sora-2", name: "Sora 2", credits: 480, isDefault: true, desc: "Флагман видеогенерации", time: "180 сек", estimatedMinutes: 3 },
      { id: "sora-2-pro", name: "Sora 2 Pro", credits: 1440, desc: "Максимальное качество", time: "300 сек", estimatedMinutes: 5 },
    ],
    aspectRatios: ["16:9", "9:16", "1:1", "4:3"],
  ...
  },
  {
    ...
    badge: "Open Source",
    subModels: [
      { id: "wan-2.1-video", name: "Wan AI", credits: 30, isDefault: true, desc: "Открытая модель", time: "90 сек", estimatedMinutes: 2 },
    ],
    aspectRatios: ["16:9", "9:16", "1:1"],
  ...
  },
  {
    ...
    badge: "NEW",
    subModels: [
      { id: "hailuo", name: "Hailuo AI", credits: 40, isNew: true, isDefault: true, desc: "Новый игрок", time: "90 сек", estimatedMinutes: 2 },
    ],
    aspectRatios: ["16:9", "9:16", "1:1"],
    durationOptions: ["5s", "8s"],
    resolutionOptions: ["720p", "1080p"],
  },
  {
    ...
    badge: "NEW",
    subModels: [
      { id: "vidu", name: "Vidu AI", credits: 40, isNew: true, isDefault: true, desc: "Новый игрок", time: "90 сек", estimatedMinutes: 2 },
    ],
    aspectRatios: ["16:9", "9:16", "1:1", "4:3"],
    durationOptions: ["5s", "8s"],
    resolutionOptions: ["720p", "1080p"],
  },
  {
    ...
    badge: "NEW",
    subModels: [
      { id: "heygen-avatar", name: "HeyGen Avatar", credits: 120, isNew: true, isDefault: true, desc: "Реалистичные AI аватары", time: "120 сек", estimatedMinutes: 2 },
      { id: "heygen-video-translate", name: "HeyGen Video Translate", credits: 150, desc: "Перевод видео с липсинком", time: "180 сек", estimatedMinutes: 3 },
    ],
    aspectRatios: ["16:9", "9:16", "1:1"],
  ...
  },
  {
    ...
    badge: "NEW",
    subModels: [
      { id: "hedra-character", name: "Hedra Character-1", credits: 80, isNew: true, isDefault: true, desc: "Говорящие персонажи", time: "60 сек", estimatedMinutes: 1 },
    ],
    aspectRatios: ["16:9", "9:16", "1:1"],
    durationOptions: ["5s", "10s", "15s"],
    resolutionOptions: ["720p", "1080p"],
